...
public class BookPricingUseCase {
    ...
    public BookPricingUseCase(final DiscountPolicies discountPolicies,
    ...
    public Book price(final BookId bookId, final Price retailPrice, final String discountPolicyName) {
        final DiscountPolicy policy = discountPolicies.withName(discountPolicyName);
        final Book book = Book.price(bookId, retailPrice, policy);
